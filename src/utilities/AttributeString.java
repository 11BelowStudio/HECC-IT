...
public class AttributeString<T>{
    ...
    */
    ...
    /*
    If you want to make it have a blank attribute but a defined suffix and value,
    just use the 1st constructor, with "" as an attribute
    Why?
    Well, suppose that <T> was set to 'String'.
    AttributeName+Value and Value+Suffix would both be (String, String)
    Which could get awkward
    Very awkward.
    So just use ("",Value,Suffix) instead.
     */
