...
public class OhHeccParserTest {
    ...
    void testDuplicateName(){
        final String dupeHeccSample = "Hecc code generated by OH-HECC at Tue Dec 08 10:10:58 GMT 2020\n" +
                ...
                "\n" +
                ";;\n" +
                "::Right [again] <128.0,-39.0> //\n" +
                "This is also the right as well.\n" +
                ";;\n" +
                "\n" +
                ";;\n" +
                "::dave [] <81.0,142.0> //oh hi dave\n" +
                ...
                "wack\n" +
                ";;\n"+
                "::dave_1 [] <81.0,142.0> //oh hi dave_1\n" +
                "This passage is dave_1.\n" +
                ";;\n" +
                ";;\n" +
                "::dave_1 [] <81.0,142.0> //oh hi dave_1\n" +
                "This passage is also dave_1.\n" +
                ";;\n" +
                ";;\n"+
                "::dave [] <81.0,142.0> //oh hi dave\n" +
                "This passage is also dave.\n" +
                ";;\n" +
                ";;\n"+
                "::bob_1 [] <81.0,142.0> //oh hi bob_1\n" +
                "This passage is bob_1.\n" +
                ";;\n" +
                ";;\n" +
                "::bob [] <81.0,142.0> //oh hi bob\n" +
                "This passage is bob.\n" +
                ";;\n" +
                ";;\n"+
                "::bob [] <81.0,142.0> //oh hi bob\n" +
                "This passage is also bob.\n" +
                ";;\n" +
                ";;\n";

        // It should rename one of the 'Right' passages to 'Right_1'

        final Set<String> dupeHeccPassageNames = new HashSet<>(
                Arrays.asList(
                    "Start","Another passage","Yet Another Passage","Left",
                        "Right","Right_1","Right_2",
                        "dave","dave_1","dave_1_1","dave_2",
                        "bob_1","bob","bob_2"
                ));
     ...
     */
    @Test
    void testUndeclaredLinkedPassage(){
    ...
    /**
     * Making sure it adds a start passage if one is missing
     */
    @Test
    void testAddingTheMissingStartPassage(){

        final String startlessHecc = "\n" +
                ...
                "end of metadata. game content starts below:\n" +
                "\n" +
                "::Another passage [yes] <54,-230> //\n" +
                "congrats you clicked that link to get here, Another passage.\n" +
                "why not [[click this|Yet Another Passage]] as well?\n" +
                ";;\n" +
                "\n" +
                ";;\n" +
                "::Yet Another Passage [] <43,-47> //oh look another passage\n" +
                "woah you clicked that so you're now at Yet Another Passage{if:pAny(\"Yet Another Passage\")}{, yet again!}{else:.}\n" +
                "\n" +
                "Do you want to go [[Left]], [[Right]], or [[Skip this nonsense|dave]]?\n" +
                ";;\n" +
                "decisions, decisions.\n" +
                ";;\n" +
                "::dave [noreturn] <137,149> //\n" +
                "This passage is called dave.\n" +
                "dave's content doesn't include any links to any other passages.\n" +
        ...
        final OhHeccParser startlessParser = new OhHeccParser(startlessHecc);


        final Set<String> thePassageNamesWithStart = new HashSet<>(Arrays.asList("Start","Another passage","Yet Another Passage","Left","Right","dave"));

        final Set<String> parsedNames = startlessParser.getHeccMap().values().stream().map(SharedPassage::getPassageName).collect(Collectors.toSet());

        System.out.println(parsedNames);

        assertEquals(thePassageNamesWithStart, parsedNames);


        final String startlessHecc2 = "\n" +
                "!title: a new heccsample\n" +
                "!author: Rachel Lowe\n" +
                "!start: Kevin\n" +
                "\n" +
        ...
        final OhHeccParser startlessParser2 = new OhHeccParser(startlessHecc2);




        final Set<String> thePassageNamesWithKevin = new HashSet<>(Arrays.asList("Kevin","Another passage","Yet Another Passage","Left","Right","dave"));

        final Set<String> parsedNames2 = startlessParser2.getHeccMap().values().stream().map(SharedPassage::getPassageName).collect(Collectors.toSet());

        System.out.println(parsedNames2);

        assertEquals(thePassageNamesWithKevin, parsedNames2);
